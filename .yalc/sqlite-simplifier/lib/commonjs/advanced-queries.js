...
exports.QueryType = exports.QueryBuilderSimplified = exports.AdvancedQuery = void 0;
exports.asc = asc;
exports.avg = avg;
exports.count = count;
exports.createAdvancedQuery = createAdvancedQuery;
exports.desc = desc;
exports.max = max;
exports.min = min;
...
function orWhere(field, operator, value) {
  return {
    field,
    operator,
    value,
 ...
 * ============================================
 */
exports.QueryBuilderSimplified = QueryBuilderSimplified;
class AdvancedQuery {
...
function createAdvancedQuery(db, enableLogging = false) {
