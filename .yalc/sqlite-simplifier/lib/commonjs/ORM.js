...
exports.ORM = void 0;
var _advancedQueries = require("./advanced-queries");
...
class ORM {
  constructor(db) {
    ...
    this.advancedQuery = new _advancedQueries.AdvancedQuery(db);
  }
  ...
  table(table) {
    return new _QueryBuilder.QueryBuilder(table, this.advancedQuery, this.relations[table] || {});
  }
